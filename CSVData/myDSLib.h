...
// By picking a large prime number here we reduce the size of our linked lists (chains) at each hash location. Since it's a prime it also avoids divisibility patterns
// such as being divisible by 3 and 5 for instance.
#define INDEX_SIZE 1007  // CODE 2: you must find a proper value that balances size/performance
